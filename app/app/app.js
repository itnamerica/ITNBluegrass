...
myApp.config(function($stateProvider, $urlRouterProvider, $locationProvider){
  ...
  $stateProvider
      ...
      .state('civil-rights', {
        url: '/civil-rights',
        templateUrl: viewsPath + 'civil-rights.html'
      })
      .state('draft', {
        url: '/draft',
...
myApp.controller('MainController', ['$scope', '$transitions','$http', '$anchorScroll', '$location', '$stateParams', '$timeout', '$state', '$rootScope', '$window', function ($scope, $transitions, $http, $anchorScroll, $location, $stateParams, $timeout, $state, $rootScope, $window)  {
  ...
  $scope.submitForm = function(formType){
    ...
    $http.post('/sendmail', {
      ...
      subject: "ITNBluegrass Contact Form Submitted",
      text: $scope.formData,
  ...
  $scope.submitFormWithPDF = function(formType){
    ...
    if (formType === 'volunteer') {
        ...
        $scope.formSubject = 'ITNBluegrass - New volunteer application received';
        ...
        $scope.showPdf = true;
        $scope.formSubject = 'ITNBluegrass - New membership application received';
        $scope.generateMultiPagePDF();
    } else if (formType === 'nonrider') {
        $scope.formSubject = 'ITNBluegrass - Non-Rider application Form submitted';
        $scope.generatePDF();
    } 
  }
